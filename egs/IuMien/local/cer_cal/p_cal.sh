...
python local/cer_cal/cer.py "$ground_truth" "$exp1_result"  --out "$cache_folder/cer_results_exp1.json" 
echo "CER results for Experiment 1 saved to $cache_folder/cer_results_exp1.json"

# Run CER for experiment 2
python local/cer_cal/cer.py "$ground_truth" "$exp2_result"  --out "$cache_folder/cer_results_exp2.json" 
